...
The solution `ArithmeticExpressionAPI.sln` contains two projects:
...
- Should cover the most significant code for the solution - mostly use cases and services;
- Unit tests written on TDD aproach (Red, Green, Refactor);
    - to focus on code design (and refactoring) more than code coverage;
- Test structure:
    - Test Classes - targeting a specific class on the main project (Arithmetic Expression API Project);
...
2. Open the solution `ArithmeticExpressionAPI.sln` file on VS 2022;
